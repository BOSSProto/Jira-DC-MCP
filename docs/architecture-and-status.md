...
v0.2.3. Read tools exercised against a live Jira DC via `npm run smoke`. Write tools exercised end-to-end against the mock only; test them in a sandbox project before enabling `full` mode against production.
